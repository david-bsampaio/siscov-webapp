...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__parallax_layout_1__ = __webpack_require__(1232);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__parallax_layout_2__ = __webpack_require__(1234);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__elastic_header_elastic_header_module__ = __webpack_require__(1159);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__parallax_layout_3__ = __webpack_require__(1236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__elastic_header_elastic_header_module__ = __webpack_require__(1159);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__parallax_layout_4__ = __webpack_require__(1237);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__elastic_header_elastic_header_module__ = __webpack_require__(1159);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__item_details_parallax__ = __webpack_require__(1285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_parallax_layout_1_parallax_layout_1_module__ = __webpack_require__(1082);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_parallax_layout_2_parallax_layout_2_module__ = __webpack_require__(1084);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_parallax_layout_3_parallax_layout_3_module__ = __webpack_require__(1086);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_parallax_layout_4_parallax_layout_4_module__ = __webpack_require__(1087);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ItemDetailsPageParallaxModule = (function () {
    ...
    ItemDetailsPageParallaxModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__item_details_parallax__["a" /* ItemDetailsPageParallax */]),
...
var ParallaxLayout2 = (function () {
    ...
    ParallaxLayout2 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'parallax-layout-2',template:/*ion-inline-start:"D:\equipe\ionic\particular\siscov-webapp\src\components\parallax\layout-2\parallax.html"*/'<!--- Theme Parallax Product -->\n\n<!--- Header Big Image-->\n\n<ion-content elastic-header *ngIf="data != null">\n\n  <div background-size id="elastic-header"\n\n   [ngStyle]="{\'background-image\': \'url(\' + data.headerImage + \')\'}">\n\n    <div class="title">\n\n      <h2 parallax-subtitle>{{data.description}}</h2>\n\n      <h1 parallax-title>{{data.title}}</h1>\n\n    </div>\n\n    <div social>\n\n      <ion-icon (click)="onEvent(\'onLike\', data)">\n\n        <i class="icon {{data.iconLike}}"></i>\n\n      </ion-icon>\n\n      <ion-icon (click)="onEvent(\'onFavorite\', data)">\n\n        <i class="icon {{data.iconFavorite}}"></i>\n\n      </ion-icon>\n\n      <ion-icon (click)="onEvent(\'onShare\', data)">\n\n        <i class="icon {{data.iconShare}}"></i>\n\n      </ion-icon>\n\n    </div>\n\n  </div>\n\n  <!--Content-->\n\n  <ion-grid no-padding>\n\n    <ion-row>\n\n      <ion-col col-12>\n\n        <ion-list no-margin>\n\n          <ion-item *ngFor="let item of data.items;let i = index" (click)="onEvent(\'onItemClick\', item)">\n\n            <ion-avatar item-left>\n\n              <img src="{{item.image}}">\n\n            </ion-avatar>\n\n            <h2 item-title>{{item.title}}</h2>\n\n            <h3 item-subtitle>{{item.description}}</h3>\n\n          </ion-item>\n\n        </ion-list>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n</ion-content>\n\n<!-- Fab Button -->\n\n<ion-fab #fab bottom right>\n\n  <button button-ion-fab ion-fab (click)="onEvent(\'onFab\', data, $event)">\n\n    <ion-icon name="add"></ion-icon>\n\n  </button>\n\n</ion-fab>\n\n'/*ion-inline-end:"D:\equipe\ionic\particular\siscov-webapp\src\components\parallax\layout-2\parallax.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], ParallaxLayout2);
...
var ParallaxLayout3 = (function () {
    ...
    ParallaxLayout3 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'parallax-layout-3',template:/*ion-inline-start:"D:\equipe\ionic\particular\siscov-webapp\src\components\parallax\layout-3\parallax.html"*/'<!--- Theme Parallax Basic -->\n\n<!--- Header Big Image-->\n\n<ion-content elastic-header *ngIf="data != null">\n\n  <ion-item no-lines background-size id="elastic-header"\n\n  [ngStyle]="{\'background-image\': \'url(\' + data.headerImage + \')\'}">\n\n    <ion-thumbnail>\n\n      <img src="{{data.avatar}}" />\n\n    </ion-thumbnail>\n\n    <div text-center>\n\n      <h1 parallax-title>{{data.title}}</h1>\n\n    </div>\n\n  </ion-item>\n\n  <!--Content-->\n\n  <ion-grid no-padding>\n\n    <ion-row>\n\n      <ion-col col-12>\n\n        <ion-list no-margin>\n\n          <ion-item *ngFor="let item of data.items;let i = index" (click)="onEvent(\'onItemClick\', item)">\n\n            <ion-avatar item-left>\n\n              <img src="{{item.image}}">\n\n            </ion-avatar>\n\n            <h2 item-title>{{item.title}}</h2>\n\n            <h3 item-subtitle>{{item.description}}</h3>\n\n            <ion-icon item-right (click)="onEvent(\'onFavorite\', item, $event)">\n\n              <i icon-small class="icon"\n\n              [ngClass]="{\'icon-heart\': item.favorite, \'icon-heart-outline\': !item.favorite}"></i>\n\n            </ion-icon>\n\n          </ion-item>\n\n        </ion-list>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n</ion-content>\n\n<!-- Fab Button -->\n\n<ion-fab #fab bottom right>\n\n  <button button-ion-fab ion-fab (click)="onEvent(\'onFab\', data, $event)">\n\n    <ion-icon name="add"></ion-icon>\n\n  </button>\n\n</ion-fab>\n\n'/*ion-inline-end:"D:\equipe\ionic\particular\siscov-webapp\src\components\parallax\layout-3\parallax.html"*/
        }),
        __metadata("design:paramtypes", [])
    ], ParallaxLayout3);
...
var ItemDetailsPageParallax = (function () {
    ...
    ItemDetailsPageParallax = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"D:\equipe\ionic\particular\siscov-webapp\src\pages\item-details-parallax\item-details-parallax.html"*/'<!--Parallax components-->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title text-left text-uppercase>{{params.title}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<!-- Content -->\n\n\n\n<!-- PAGE PARALLAX - Player -->\n\n<parallax-layout-1 has-header *ngIf="params.parallaxLayout1" [data]="params.data | async" [events]="params.events">\n\n</parallax-layout-1>\n\n\n\n<!-- PAGE PARALLAX - Product -->\n\n<parallax-layout-2 has-header *ngIf="params.parallaxLayout2" [data]="params.data | async" [events]="params.events">\n\n</parallax-layout-2>\n\n\n\n<!-- PAGE PARALLAX - Basic -->\n\n<parallax-layout-3 has-header *ngIf="params.parallaxLayout3" [data]="params.data | async" [events]="params.events">\n\n</parallax-layout-3>\n\n\n\n<!-- PAGE PARALLAX - Location Details -->\n\n<parallax-layout-4 has-header *ngIf="params.parallaxLayout4" [data]="params.data | async" [events]="params.events">\n\n</parallax-layout-4>\n\n'/*ion-inline-end:"D:\equipe\ionic\particular\siscov-webapp\src\pages\item-details-parallax\item-details-parallax.html"*/
        }),
